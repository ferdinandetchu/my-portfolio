...
const CalendlyModal = dynamic(() => import('@/components/calendly-modal').then(mod => mod.CalendlyModal));
...
export function ActionButtons() {
  return (
    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
      ...
      <a href="https://wa.me/237671097299?text=Hello%20Ferdinand,%20I'm%20contacting%20you%20from%20your%20portfolio%20website." target="_blank" rel="noopener noreferrer">
